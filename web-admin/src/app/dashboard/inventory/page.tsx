    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Monitor stock levels and warehouse distribution</p>
        </div>
      </div>
      ...
      <div className="bg-card border border-border rounded-2xl overflow-hidden">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead>
              <tr className="bg-background/50 text-muted-foreground font-medium border-b border-border">
            ...
            <tbody className="divide-y divide-border">
              {isLoading ? (
                ...
                <tr key={p.id} className="hover:bg-accent/30 transition-colors">
                  ...
                  <td className="px-6 py-4 font-mono text-[11px] text-muted-foreground">{p.sku || 'N/A'}</td>
                  <td className="px-6 py-4 text-muted-foreground">{p.category || 'Uncategorized'}</td>

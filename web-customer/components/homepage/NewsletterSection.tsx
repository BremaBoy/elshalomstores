...
export const NewsletterSection = () => {
  return (
    <section className="py-24 md:py-32 bg-primary/10">
      <Container>
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16 bg-primary text-white p-10 md:p-20 rounded-[3rem] shadow-2xl shadow-primary/15 relative overflow-hidden">
          ...
          <div className="space-y-6 text-center lg:text-left relative z-10">
            <div className="h-16 w-16 bg-primary/10 flex items-center justify-center rounded-[2rem] mx-auto lg:mx-0 shadow-inner">
              <Mail className="h-8 w-8 text-gold-soft" />
            </div>
          ...
          <div className="w-full max-w-md relative z-10">
            <form className="flex flex-col gap-4">
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full h-16 bg-white/10 border border-white/25 rounded-full px-8 outline-none focus:border-gold-soft transition-all font-bold text-white placeholder:text-white/80"
                />
              </div>
            ...
            <p className="mt-6 text-[10px] font-black uppercase tracking-widest text-white/80 text-center lg:text-left">
              By subscribing, you agree to our <Link href="/privacy" className="text-gold-soft hover:underline">Privacy Policy</Link>
            </p>
          </div>
        </div>
      </Container>
